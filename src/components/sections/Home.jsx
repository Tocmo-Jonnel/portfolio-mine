            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                        I am a 4th-year BS Information Technology Student with a 
                        strong passion for Web Development, aspiring to become a
                    ...
                    <div className="flex justify-center space-x-4">
                        ...
                        className="bg-blue-500 text-white py-3 px-6 
                            ...
                            hover:-translate-y-1 
                            hover:shadow-[0_0_15px_rgba(59, 130, 254, 0.4)]">
                        View Projects
                        </a>
                        ...
                        className="border border-blue-500/50 text-blue-500 
                            ...
                            hover:-translate-y-1 
                            hover:shadow-[0_0_15px_rgba(59, 130, 254, 0.2)]
